    ...
    render() {
        ...
        return (<div 
         ...
         >
            ...
            <MenuItem eventKey="3" onClick={e => { sendAsImage(id, "7TV_cast-"+slug(this.props.character.name||this.props.character.id)+"_{n}.png",{scale:2, selector:'.cellophan'})}}>Download as Separate Images</MenuItem>
